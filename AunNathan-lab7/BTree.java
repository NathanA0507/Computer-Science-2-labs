...
public class BTree<T> {
    ...
    public void print(BTNode<T> n) {
        System.out.println(n.getData()); //root
		if(n.getLeft() != null)
			print(n.getLeft()); //left 
		if(n.getRight() != null)
			print(n.getRight()); //right
    }
    ...
    public void inOrderTraversal(BTNode<T> n) {
		...
		if(n.getLeft() != null)
			inOrderTraversal(n.getLeft()); //Left
        System.out.println(n.getData()); //root
		if(n.getRight() != null)
			inOrderTraversal(n.getRight()); //right
    }
}